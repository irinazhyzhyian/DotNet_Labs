...
namespace Lab3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            teams[0] = new ResearchTeam("topic43", "name563", 123456, TimeFrame.TwoYears);
            ...
            //Console.Write(teams[1].ToString());
            ...
            researchTeamCollection.SotrByTeamNumber();
            Console.WriteLine(researchTeamCollection.ToString()+"\n\n");
            ...
            Console.WriteLine(researchTeamCollection.ToShortString() + "\n\n");

            Console.WriteLine("\n\n\n\n\n");
            Console.WriteLine("2. Викликати методи класу ResearchTeamCollection, що виконують операції зі списком List<ResearchTeam> та після кожної операції вивести результат.\n");
            ...
            test.searchInListString();
            test.searchInListKey();
            test.searchInDictStringByValue();
            test.searchInDictString();
            test.searchInDictKeyByValue();
            test.searchInDictKey();
